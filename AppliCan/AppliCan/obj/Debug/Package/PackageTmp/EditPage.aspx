            ...
            <tr>
                <td>
                    ...
                    <div>
                        ...
                        &nbsp;
                        <asp:DropDownList ID="CountryDropDownList" runat="server" AutoPostBack="True" DataSourceID="CountrySqlDataSource" DataTextField="country" DataValueField="country">
                        ...
                        &nbsp;
                        <asp:DropDownList ID="StateDropDownList" runat="server" Visible="False" DataSourceID="StateSqlDataSource" DataTextField="StateName" DataValueField="StateName" AutoPostBack="True">
                    ...
                    <div>
                        ...
                        &nbsp;
                        <asp:DropDownList ID="AppliedDDL" runat="server" >
                ...
                <td>
                    ...
                    <asp:Panel ID="MiddleAppliedPanel" runat="server" Visible="false">
                        <div>
                            ...
                            &nbsp;
                            <asp:DropDownList ID="AskedInterviewDropDownList" runat="server" AutoPostBack="True" >
                ...
                <td>
                    <asp:Panel ID="EntireRightColumnPanel" runat="server" Visible="False">
                        <div>
                            ...
                            &nbsp;
                            <asp:DropDownList ID="OfferDropDownList" runat="server" AutoPostBack="True">
                                <asp:ListItem>TBD</asp:ListItem>
                                <asp:ListItem>Yes</asp:ListItem>
                                <asp:ListItem>No</asp:ListItem>
                            </asp:DropDownList>
